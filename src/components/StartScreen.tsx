...
const StartScreen = ({ onStore, onPickup }: StartScreenProps) => (
  <div className="flex flex-col items-center gap-10 py-12 animate-fade-in">
    ...
    <div className="flex gap-6">
      ...
      <button onClick={onPickup} className="btn-locker bg-card text-foreground border border-border hover:border-primary/40 flex flex-col items-center gap-3 min-w-[200px]">
